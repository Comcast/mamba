...
class HLSResolutionTests: XCTestCase {
    
    func testResolution() {
        let resolution1080 = HLSResolution(resolution: "1920x1080")
        ...
        let resolution720 = HLSResolution(width: 1280, height: 720)
        ...
        let resolution1080p = HLSResolution(width: 1920, height: 1080)
    ...
    func testRatio() {
        let resolution4K = HLSResolution(resolution: "3840x2160")!
        let resolution1080 = HLSResolution(resolution: "1920x1080")!
        let resolution720 = HLSResolution(resolution: "1280x720")!
        let resolution432 = HLSResolution(resolution: "768x432")!
        let resolution360 = HLSResolution(resolution: "640x360")!
        let resolution288 = HLSResolution(resolution: "512x288")!
        let resolution180 = HLSResolution(resolution: "320x180")!
        ...
        XCTAssert(resolution4K.ratio == HLSResolution.ratio16x9)
        XCTAssert(resolution1080.ratio == HLSResolution.ratio16x9)
        XCTAssert(resolution720.ratio == HLSResolution.ratio16x9)
        XCTAssert(resolution432.ratio == HLSResolution.ratio16x9)
        XCTAssert(resolution360.ratio == HLSResolution.ratio16x9)
        XCTAssert(resolution288.ratio == HLSResolution.ratio16x9)
        XCTAssert(resolution180.ratio == HLSResolution.ratio16x9)
        
        let resolutionSD = HLSResolution(resolution: "640x480")!
        let resolutionEDTV576p = HLSResolution(resolution: "768x576")!
        ...
        XCTAssert(resolutionSD.ratio == HLSResolution.ratio4x3)
        XCTAssert(resolutionEDTV576p.ratio == HLSResolution.ratio4x3)
    }
    
    func testResolution1_Failure() {
        let resolution = HLSResolution(resolution: "")
        
        XCTAssert(resolution == nil, "should not have been created")
    }

    func testResolution2_Failure() {
        let resolution = HLSResolution(resolution: "a")
        
        XCTAssert(resolution == nil, "should not have been created")
    }

    func testResolution3_Failure() {
        let resolution = HLSResolution(resolution: "1080")
        
        XCTAssert(resolution == nil, "should not have been created")
    }

    func testResolution4_Failure() {
        let resolution = HLSResolution(resolution: "1920:1080")
        
        XCTAssert(resolution == nil, "should not have been created")
    }

    func testResolution5_Failure() {
        let resolution = HLSResolution(resolution: "x1080")
        
        XCTAssert(resolution == nil, "should not have been created")
    }
    
    func testResolution6_Failure() {
        let resolution = HLSResolution(resolution: "1920x")
