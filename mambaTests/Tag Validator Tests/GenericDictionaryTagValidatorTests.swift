...
class GenericDictionaryTagValidatorTests: XCTestCase {
    ...
    func test_EXT_X_SESSION_KEY() {
        ...
        let EXT_X_SESSION_KEY_withNoURIAndMETHODEqualToNONE = {
            ...
            let tag = createHLSTag(tagDescriptor: PantosTag.EXT_X_SESSION_KEY, tagData: tagData)
 ...
 */
    ...
    private func validateEXT_X_DATERANGE(tagData: String, expectedValidationIssues: [HLSValidationIssue]) {
