 ...
 */
    ...
    func test_EXT_X_DATERANGE() {
        ...
        var validationIssues = [PlaylistValidationIssue(description: .EXT_X_DATERANGEEND_ON_NEXTValueMustBeYES, severity: .error)]
        ...
        validationIssues = [PlaylistValidationIssue(description: .EXT_X_DATERANGETagWithEND_ON_NEXTMustHaveCLASSAttribute, severity: .error)]
        validateEXT_X_DATERANGE(tagData: data, expectedValidationIssues: validationIssues)
        ...
        validationIssues = [PlaylistValidationIssue(description: .EXT_X_DATERANGETagWithEND_ON_NEXTMustNotContainDURATION, severity: .error)]
        validateEXT_X_DATERANGE(tagData: data, expectedValidationIssues: validationIssues)
        ...
        validationIssues = [PlaylistValidationIssue(description: .EXT_X_DATERANGETagWithEND_ON_NEXTMustNotContainEND_DATE, severity: .error)]
        validateEXT_X_DATERANGE(tagData: data, expectedValidationIssues: validationIssues)
        ...
        validationIssues = [PlaylistValidationIssue(description: .EXT_X_DATERANGEValidatorDURATIONAndEND_DATEMustMatchWithSTART_DATE, severity: .error)]
        validateEXT_X_DATERANGE(tagData: data, expectedValidationIssues: validationIssues)
        ...
        validationIssues = [PlaylistValidationIssue(description: .EXT_X_DATERANGEEND_ON_NEXTValueMustBeYES, severity: .error),
                            PlaylistValidationIssue(description: .EXT_X_DATERANGETagWithEND_ON_NEXTMustHaveCLASSAttribute, severity: .error),
                            PlaylistValidationIssue(description: .EXT_X_DATERANGETagWithEND_ON_NEXTMustNotContainDURATION, severity: .error),
                            PlaylistValidationIssue(description: .EXT_X_DATERANGETagWithEND_ON_NEXTMustNotContainEND_DATE, severity: .error),
                            PlaylistValidationIssue(description: .EXT_X_DATERANGEValidatorDURATIONAndEND_DATEMustMatchWithSTART_DATE, severity: .error),
                            PlaylistValidationIssue(description: "EXT-X-DATERANGE mandatory value id is missing.", severity: .error)]
        validateEXT_X_DATERANGE(tagData: data, expectedValidationIssues: validationIssues)
    }
