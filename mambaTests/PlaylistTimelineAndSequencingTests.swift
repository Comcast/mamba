//
//  PlaylistTimelineAndSequencingTests.swift
//  mamba
//
...
class PlaylistTimelineAndSequencingTests: XCTestCase {
    
    func testMediaSequenceMissing() {
        // ***
        // *** Setup
        
        let playlist = parseVariantPlaylist(inString: sampleVariantPlaylist_mediaSequenceMissing)
    ...
    func testMediaSequence4() {
        ...
        let playlist = parseVariantPlaylist(inString: sampleVariantPlaylist_mediaSequence4)
    ...
    func runTest(forTimeline timeline: PlaylistTimelineTranslator, mediaSequence: MediaSequence, hasStartTimeInMilliseconds startTimeInMilliseconds: Int64, andHasEndTimeInMilliseconds endTimeInMilliseconds: Int64) -> Bool {
    ...
    func runTest(forTimeline timeline: PlaylistTimelineTranslator, tagAtIndex index: Int, isPartOfMediaSequence mediaSequence: MediaSequence) -> Bool {
        return timeline.mediaSequence(forTagIndex: index) == mediaSequence
    }
    
    func runTest(forTimeline timeline: PlaylistTimelineTranslator, tagAtIndex index: Int, hasStartTimeInMilliseconds startTimeInMilliseconds: Int64, andHasEndTimeInMilliseconds endTimeInMilliseconds: Int64) -> Bool {
    ...
    func runTest(forTimeline timeline: PlaylistTimelineTranslator, timeInMilliseconds: Int64, belongsToMediaSequence mediaSequence: MediaSequence) -> Bool {
    ...
    func runTest(forTimeline timeline: PlaylistTimelineTranslator, mediaSequence: MediaSequence, shouldMatchBeginTagIndex beginTagIndex: Int, andEndTagIndex endtagIndex: Int) -> Bool {
    ...
    func runTest(forTimeline timeline: PlaylistTimelineTranslator, timeInMilliseconds: Int64, shouldMatchBeginTagIndex beginTagIndex: Int, andEndTagIndex endtagIndex: Int) -> Bool {
