...
class StringDictionaryParserTests: XCTestCase {
    ...
    func testStringDictionaryParser0() {
        do {
            let dict = try StringDictionaryParser.parseToHLSTagDictionary(fromParsableString: "key1=value1")
    ...
    func testStringDictionaryParser2() {
        do {
            let dict = try StringDictionaryParser.parseToHLSTagDictionary(fromParsableString: "key1=value1,key2=value2")
    ...
    func testStringDictionaryParser3() {
        do {
            let dict = try StringDictionaryParser.parseToHLSTagDictionary(fromParsableString: "key1=value1,key2=\"value2,value3\"")
    ...
    func testStringDictionaryParser4() {
        do {
            let dict = try StringDictionaryParser.parseToHLSTagDictionary(fromParsableString: "key1=\"value1,value2\",key2=value3")
    ...
    func testStringDictionaryParser5() {
        do {
            let dict = try StringDictionaryParser.parseToHLSTagDictionary(fromParsableString: "key1=\"value1,value2\",key2=\"value3,value4\"")
    ...
    func testStringDictionaryParser6() {
        do {
            let dict = try StringDictionaryParser.parseToHLSTagDictionary(fromParsableString: "key1=\"value1,value2,value3\",key2=\"value3,value4\"")
    ...
    func testStringDictionaryParser7() {
        do {
            let dict = try StringDictionaryParser.parseToHLSTagDictionary(fromParsableString: "key1=\"value1,value2\",key2=value3,key3=\"value5,value6\"")
    ...
    func testStringDictionaryParser8() {
        do {
            let dict = try StringDictionaryParser.parseToHLSTagDictionary(fromParsableString: "key1=value1,key2=\"value3,value4\",key3=\"value5,value6\"")
    ...
    func testStringDictionaryParser9() {
        do {
            let dict = try StringDictionaryParser.parseToHLSTagDictionary(fromParsableString: "key1=\"value1,value2\",key2=\"value3,value4\",key3=value5")
    ...
    func testStringDictionaryParser10() {
        do {
            let dict = try StringDictionaryParser.parseToHLSTagDictionary(fromParsableString: "text=\"text,text") // slightly misformatted, but we can deal with the missing closing quote
    ...
    func testStringDictionaryParser11() {
        do {
            let dict = try StringDictionaryParser.parseToHLSTagDictionary(fromParsableString: "key1=\"value1=value2\"")
    ...
    func testStringDictionaryParser14() {
        do {
            let dict = try StringDictionaryParser.parseToHLSTagDictionary(fromParsableString: "key1=\"value1=value2\",key2=\"value3\",key3=\"value4=value5\"")
    ...
    func testStringDictionaryParser15() {
        do {
            let dict = try StringDictionaryParser.parseToHLSTagDictionary(fromParsableString: "key1=\"value1,value2\",key2=\"value3=value4,value5=value6\",key3=value7")
    ...
    func testStringDictionaryParser16() {
        do {
            let dict = try StringDictionaryParser.parseToHLSTagDictionary(fromParsableString: "text1=,text2=text3")
    ...
    func testStringDictionaryParser18() {
        do {
            let dict = try StringDictionaryParser.parseToHLSTagDictionary(fromParsableString: "text1=")
    ...
    func testStringDictionaryParserFailure1() {
        do {
            let _ = try StringDictionaryParser.parseToHLSTagDictionary(fromParsableString: "text")
    ...
    func testStringDictionaryParserFailure3() {
        do {
            let _ = try StringDictionaryParser.parseToHLSTagDictionary(fromParsableString: "text,text")
    ...
    func testStringDictionaryParserFailure4() {
        do {
            let _ = try StringDictionaryParser.parseToHLSTagDictionary(fromParsableString: "text=text,text")
    ...
    func testStringDictionaryParserFailure6() {
        do {
            let _ = try StringDictionaryParser.parseToHLSTagDictionary(fromParsableString: "text=text,text,text=text")
