...
class ValidatorTests: XCTestCase {
    ...
    func testPlaylistAggregateTagGroupValidatorOK() {
        
        let u = PlaylistRenditionGroupValidator.self
        let hlsLoadString = EXT_X_MEDIA_txt.joined()
        validate(validator: u, playlist: hlsLoadString, expected: 0)
    }
    
    func testPlaylistAggregateTagGroupValidatorMultipleFails() {
    ...
    func testPlaylistAggregateTagCardinalityValidatorOK() {
        
        let u = PlaylistAggregateTagCardinalityValidator.self
        let hlsLoadString = EXT_X_MEDIA_SEQUENCE_txt.joined()
        validate(validator: u, playlist: hlsLoadString, expected: 0)
    }
    
    func testPlaylistAggregateTagCardinalityValidatorDuplicate() {
    ...
    func testPlaylistAggregateTagCardinalityValidatorDuplicateTARGET_DURATION() {
    ...
    func testPlaylistAggregateTagCardinalityValidatorMissingTARGET_DURATION() {
    ...
    func testPlaylistAggregateTagCardinalityValidatorMultipleDuplicates() {
    ...
    func testPlaylistAggregateTagCardinalityValidatorMissing() {
    ...
    func testAudioGroupOK() {
        ...
        let u = PlaylistRenditionGroupAUDIOValidator.self
    ...
    func testVideoGroupOK() {
        ...
        let u = PlaylistRenditionGroupVIDEOValidator.self
        validate(validator: u, playlist: hlsLoadString, expected: 0)
    }
    ...
    func testEXT_X_STREAM_INFRenditionGroupVIDEOValidatorMissingAllEXT_X_STREAM_INF() {
        ...
        var hlsLoadString = newGroup.map { $0.replacingOccurrences(of: "AUDIO", with: "VIDEO") }.joined()
        hlsLoadString += masterStreamInf
        validate(validator: u, playlist: hlsLoadString, expected: 0)
    }
...
"""
    ...
    func testMatchingPROGRAM_IDValidatorOK() {
        ...
        let hlsLoadString = AudioVideoGroup_txt.joined()
        let u = PlaylistRenditionGroupMatchingPROGRAM_IDValidator.self
        validate(validator: u, playlist: hlsLoadString, expected: 0)
    }
    ...
    func testRenditionGroupMatchingNAMELANGUAGEValidatorOK() {
        ...
        let hlsLoadString = AudioVideoGroup_txt.joined()
        let u = PlaylistRenditionGroupMatchingNAMELANGUAGEValidator.self
        validate(validator: u, playlist: hlsLoadString, expected: 0)
    }
