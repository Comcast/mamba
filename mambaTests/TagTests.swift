...
class TagTests: XCTestCase {
    ...
    func createTag() -> PlaylistTag {
        ...
        let tag = PlaylistTag(tagDescriptor: PantosTag.EXT_X_STREAM_INF,
                              tagData: MambaStringRef(string: tagData),
                              tagName: MambaStringRef(descriptor: PantosTag.EXT_X_STREAM_INF),
    ...
    func testQuoteEscapingBehaviors_NewKeyValuesShouldTakeForcedValueOrDefaultToFalse() {
        ...
        var tag = PlaylistTag(tagDescriptor: PantosTag.EXT_X_STREAM_INF,
    ...
    func testTagEqualityAndHash() {
        ...
        let tag3 = PlaylistTag(tagDescriptor: PantosTag.EXT_X_STREAM_INF,
                               tagData: MambaStringRef(),
                               tagName: MambaStringRef(descriptor: PantosTag.EXT_X_STREAM_INF))
