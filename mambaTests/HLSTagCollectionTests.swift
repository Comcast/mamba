...
class HLSTagCollectionTests: XCTestCase {
    ...
    func testSAP() {
        let sapMaster = parseManifest(inFixtureName: "super8demuxed1_4242.m3u8")
        let nonsapMaster = parseManifest(inFixtureName: "hls_sampleMasterFile.txt")
    ...
    func testAudioOnlyStream() {
        let audioOnlyMaster = parseManifest(inFixtureName: "super8demuxed1_4242.m3u8")
        let nonAudioOnlyMaster = parseManifest(inFixtureName: "hls_sampleMasterFile.txt")
    ...
    func testFilteredBy() {
        let master = parseManifest(inFixtureName: "super8demuxed1_4242.m3u8")
