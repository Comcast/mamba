...
class PlaylistTagGroupTests: XCTestCase {
    
    func testTagGroup() {
        let begin = 34526
        let end = 76352
        let tagGroup = PlaylistTagGroup(range: begin...end)
    ...
    func testMediaSegmentPlaylistTagGroup() {
        let begin = 34526
        let end = 76352
        ...
        let tagGroup = MediaSegmentPlaylistTagGroup(range: begin...end, mediaSequence: mediaSequence, timeRange: timeRange, discontinuity: false)
    ...
    func testTagSpan() {
        ...
        let tag = PlaylistTag(tagDescriptor: PantosTag.EXTINF, tagData:extinfTagData, tagName: MambaStringRef(string: PantosTag.EXTINF.toString()), duration: extinfTagData.extinfSegmentDuration())
        let tagSpan = PlaylistTagSpan(parentTag: tag, tagMediaSpan: begin...end)
