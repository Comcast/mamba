//
//  PlaylistStructureAndEditingTests.swift
//  mamba
//
...
class PlaylistStructureAndEditingTests: XCTestCase {
    
    func testHLSWithNoXKeys() {
        let playlist = parseVariantPlaylist(inString: sampleVariantPlaylist_NoXKeys)
    ...
    func testHLSWithXKeys() {
        let playlist = parseVariantPlaylist(inString: sampleVariantPlaylist_XKeys)
    ...
    func testHLSWithMissingEXTINF_MissingFooter() {
        let playlist = parseVariantPlaylist(inString: sampleVariantPlaylist_NoFooter)
    ...
    func testHLSWithMissingEXTINF_CustomMediaSequence() {
        let playlist = parseVariantPlaylist(inString: sampleVariantPlaylist_MediaSequenceStartsAt2)
    ...
    func testHLSInsertSingleTag() {
        var playlist = parseVariantPlaylist(inString: sampleVariantPlaylist_XKeys)
    ...
    func testHLSMultipleDeletes() {
        ...
        var playlist = parseVariantPlaylist(inString: sampleDeletableComments)
    ...
    func testHLSCrossGroupDelete() {
        ...
        var playlist = parseVariantPlaylist(inString: sample4SegmentPlaylist)
    ...
    func testHLS_MissingEXTINF() {
        let playlist = parseVariantPlaylist(inString: sampleVariantPlaylist_MissingEXTINF)
    ...
    func testCopyOnWrite() {
        ...
        var playlist1 = parseVariantPlaylist(inString: sampleVariantPlaylist_XKeys)
    ...
    func testSpanTagInHeader() {
        ...
        let playlist = parseVariantPlaylist(inString: sampleSpanInHeader)
