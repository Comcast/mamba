//
//  PlaylistRenditionGroupMatchingPROGRAM_IDValidator.swift
//  mamba
//
...
class PlaylistRenditionGroupMatchingPROGRAM_IDValidator: MasterPlaylistCollectionValidator {    
    
    static let tagIdentifierPairs: [TagIdentifierPair] = [(tagDescriptor: PantosTag.EXT_X_STREAM_INF, valueIdentifier: PantosValue.programId),
            ...
            return { (tags: [PlaylistTag]) -> [PlaylistValidationIssue] in
                ...
                for tag in tags {
                    if tag.value(forValueIdentifier: PantosValue.programId) != programId {
                        return [PlaylistValidationIssue(description: IssueDescription.PlaylistRenditionGroupMatchingPROGRAM_IDValidator, severity: IssueSeverity.error)]
                    }
                }
                return [PlaylistValidationIssue]()
            }
