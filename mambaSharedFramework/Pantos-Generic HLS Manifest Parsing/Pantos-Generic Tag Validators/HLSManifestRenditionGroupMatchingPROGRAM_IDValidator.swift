//
//  HLSManifestRenditionGroupMatchingPROGRAM_IDValidator.swift
//  mamba
//
...
class HLSManifestRenditionGroupMatchingPROGRAM_IDValidator: HLSManifestCollectionValidator {
            ...
            return { (tags: [HLSTag]) -> [HLSValidationIssue]? in
                ...
                for tag in tags {
                    if tag.value(forValueIdentifier: PantosValue.programId) != programId {
                        return [HLSValidationIssue(description: IssueDescription.HLSManifestRenditionGroupMatchingPROGRAM_IDValidator, severity: IssueSeverity.error)]
                    }
                }
                return nil
            }
