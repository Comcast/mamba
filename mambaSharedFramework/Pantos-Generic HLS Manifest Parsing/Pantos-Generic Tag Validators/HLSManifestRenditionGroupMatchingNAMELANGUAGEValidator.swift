//
//  HLSManifestRenditionGroupMatchingNAMELANGUAGEValidator.swift
//  mamba
//
...
class HLSManifestRenditionGroupMatchingNAMELANGUAGEValidator: HLSManifestTagCrossGroupValidator {
            ...
            for tags in groups.values {
                if let names = names, let languages = languages {
                    ...
                    if localNames.count != names.count || localLanguages.count != languages.count {
                        issues += [HLSValidationIssue(description: IssueDescription.HLSManifestRenditionGroupMatchingNAMELANGUAGEValidator, severity: IssueSeverity.error)]
                    }
