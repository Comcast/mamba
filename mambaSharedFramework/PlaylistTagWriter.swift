...
/// Describes an object that can serialize individual PlaylistTag objects
public protocol PlaylistTagWriter {
    
    /**
     Writes the data of the tag to the provided OutputStream.
     Does not need to write newlines (handled by the caller).
     
     - parameter tag: The PlaylistTag to write to the stream
