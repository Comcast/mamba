 ...
 */
public typealias PlaylistConstructor<CD, R> = (BaseParserResult, CD, RegisteredTags, Data) -> (R)
...
private func constructMasterOrVariantPlaylist(withBaseParserResult baseParserResult: BaseParserResult,
    ...
    case .success(let tags):
        switch tags.type() {
        case .master:
            return ParserResult.parsedMaster(MasterPlaylist(tags: tags, registeredTags: registeredTags, playlistData: playlistData, customData: urlData))
        case .media:
            return ParserResult.parsedVariant(VariantPlaylist(tags: tags, registeredTags: registeredTags, playlistData: playlistData, customData: urlData))
        case .unknown:
...
public typealias ParserSuccess = ([PlaylistTag]) -> (Swift.Void)
