 ...
 */
@interface HLSStringRef : NSObject

+ (instancetype _Nonnull)new NS_UNAVAILABLE;

/**
 Instantiates an HLSStringRef referencing unowned memory containing a UTF-8 string.
...
/**
 Instantiates an HLSStringRef with the contents of the provided NSData.
 This creates a strong reference to the NSData instance.
 */
- (instancetype _Nonnull)initWithData:(NSData * _Nonnull)data;

/**
 Instantiates an HLSStringRef with the contents of the provided NSString.
 This creates a strong reference to the NSString instance.
 */
- (instancetype _Nonnull)initWithString:(NSString * _Nonnull)string;

/**
 Instantiates an HLSStringRef with the contents of the provided NSURL.
...
/**
 Instantiates an HLSStringRef with a base URL and a relative component.
 Neither object is retained.
 If an absolute URL cannot be formed, this will return nil.
 */
- (instancetype _Nullable)initWithHLSStringRef:(HLSStringRef * _Nonnull)relativeURL relativeToURL:(NSURL * _Nonnull)baseUrl;
...
/**
 Returns the internal storage of the HLSStringRef.
 
 @discussion The lifetime of this buffer will be no longer than the owning HLSStringRef and may be shorter. You should not retain
