...
- (void)parseHLSData:(NSData * _Nonnull)data callback:(id<RapidParserCallback> _Nonnull)callback {
...
- (void)newTagWithStartTagName:(UInt64)startTagName
    ...
    MambaStringRef *tagName = [[MambaStringRef alloc] initWithBytesNoCopy:[self.data bytes] + startTagName length:(NSUInteger)(endTagName - startTagName + 1)];
    MambaStringRef *tagData = [[MambaStringRef alloc] initWithBytesNoCopy:[self.data bytes] + startTagData length:(NSUInteger)(endTagData - startTagData + 1)];
...
- (void)newEXTINFTagWithStartTagName:(UInt64)startTagName
    ...
    MambaStringRef *tagName = [[MambaStringRef alloc] initWithBytesNoCopy:[self.data bytes] + startTagName length:(NSUInteger)(endTagName - startTagName + 1)];
    MambaStringRef *duration = [[MambaStringRef alloc] initWithBytesNoCopy:[self.data bytes] + startDuration length:(NSUInteger)(endDuration - startDuration + 1)];
    MambaStringRef *tagData = [[MambaStringRef alloc] initWithBytesNoCopy:[self.data bytes] + startTagData length:(NSUInteger)(endTagData - startTagData + 1)];
...
- (void)newCommentWithStart:(UInt64)startComment
    ...
    MambaStringRef *comment = [[MambaStringRef alloc] initWithBytesNoCopy:[self.data bytes] + startComment length:(NSUInteger)(endComment - startComment + 1)];
...
- (BOOL)newURLWithStart:(UInt64)startURL
    ...
    MambaStringRef *url = [[MambaStringRef alloc] initWithBytesNoCopy:[self.data bytes] + startURL length:(NSUInteger)(endURL - startURL + 1)];
