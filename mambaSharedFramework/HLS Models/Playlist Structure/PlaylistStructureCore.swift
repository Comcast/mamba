...
public final class PlaylistStructureCore<T: EmptyInitializerImplementor, PSD: PlaylistStructureDelegate & EmptyInitializerImplementor>: PlaylistStructureInterface where PSD.T == T {
    ...
    public convenience init(withTags tags: [HLSTag]) {
    ...
    public func insert(tag: HLSTag, atIndex index: Int) {
        queue.sync {
    ...
    public func insert(tags: [HLSTag], atIndex index: Int) {
        queue.sync {
    ...
    public func delete(atRange range: HLSTagIndexRange) {
        queue.sync {
    ...
    public func transform(_ mapping: (HLSTag) throws -> (HLSTag)) throws {
        try queue.sync {
...
public protocol PlaylistStructureDelegate: class {
     ...
     */
    func rebuild(usingTagArray tags: [HLSTag]) -> T
...
struct PlaylistStructureConstructor {
    ...
    func generateMediaGroups(fromTags tags: [HLSTag]) throws -> (header: TagGroup?, mediaSegmentGroups: [MediaSegmentTagGroup], footer: TagGroup?) {
    ...
    static func generateMediaSpans(fromTags tags:[HLSTag],
                                   header: TagGroup?,
