...
protocol HLSPlaylistRenditionGroupAudioVideoValidator: HLSPlaylistTagGroupValidator {
    static var description: IssueDescription { get }
}

extension HLSPlaylistRenditionGroupAudioVideoValidator {
...
class HLSPlaylistRenditionGroupAUDIOValidator: HLSPlaylistRenditionGroupAudioVideoValidator {
    class var description: IssueDescription {
        get {
            return IssueDescription.HLSPlaylistRenditionGroupAUDIOValidator
        }
    }
...
class HLSPlaylistRenditionGroupVIDEOValidator: HLSPlaylistRenditionGroupAudioVideoValidator {
    class var description: IssueDescription {
        get {
            return IssueDescription.HLSPlaylistRenditionGroupVIDEOValidator
        }
    }
    static let tagIdentifierPairs: [HLSTagIdentifierPair] = [(PantosTag.EXT_X_MEDIA, PantosValue.groupId),
