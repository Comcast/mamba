...
public protocol VariantPlaylistValidator {
    ...
    /**
     ...
     - returns: An array of `HLSValidationIssue`s. Will be empty if no issues are found.
     */
...
public extension ExtensibleVariantPlaylistValidator {
    ...
    /**
     ...
     - returns: An array of `HLSValidationIssue`s. Will be empty if no issues are found.
     */
    static func combinedValidation(ofVariantPlaylist variantPlaylist: VariantPlaylistInterface) -> [HLSValidationIssue] {
