//
//  HLSPlaylistCollectionValidator.swift
//  mamba
//
...
extension HLSPlaylistCollectionValidator {
    ...
    static func validate(hlsPlaylist: HLSPlaylistInterface) -> [HLSValidationIssue]? {
        let tags = (try? hlsPlaylist.tags.filter(filter)) ?? []
